...
<body>
    ...
    <script src="<spring:url value="/resources/vendor/flot/excanvas.min.js" />"></script>
    <script src="<spring:url value="/resources/vendor/flot/jquery.flot.js" />"></script>
    <script src="<spring:url value="/resources/vendor/flot/jquery.flot.pie.js" />"></script>
    <script src="<spring:url value="/resources/vendor/flot/jquery.flot.resize.js" />"></script>
    <script src="<spring:url value="/resources/vendor/flot/jquery.flot.time.js" />"></script>
    <script src="<spring:url value="/resources/vendor/flot-tooltip/jquery.flot.tooltip.min.js" />"></script>
    <script src="<spring:url value="/resources/data/flot-data.js" />"></script>
