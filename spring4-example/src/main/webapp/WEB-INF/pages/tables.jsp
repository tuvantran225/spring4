...
<head>
    ...
    <!-- DataTables CSS -->
    <link href="<spring:url value="/resources/vendor/datatables-plugins/dataTables.bootstrap.css" />" rel="stylesheet">

    <!-- DataTables Responsive CSS -->
    <link href="<spring:url value="/resources/vendor/datatables-responsive/dataTables.responsive.css" />" rel="stylesheet">
...
<body>
    ...
    <script src="<spring:url value="/resources/vendor/datatables/js/jquery.dataTables.min.js" />"></script>
    <script src="<spring:url value="/resources/vendor/datatables-plugins/dataTables.bootstrap.min.js" />"></script>
    <script src="<spring:url value="/resources/vendor/datatables-responsive/dataTables.responsive.js" />"></script>
